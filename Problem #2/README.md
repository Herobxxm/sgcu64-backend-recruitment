...
## แนะนำก่อนใช้งาน
  - แนะนำให้ run โดยใช้ไฟล์ .exe มากกว่า เพราะการ run ผ่าน ide เช่น VSCode อาจทำให้ เกิดบัคใน console ได้
  - การใช้งาน สามารถใช้งานได้ด้วย ปุ่ม arrow key และ ปุ่ม Enter Key  

## Instruction
  1. เมื่อเริ่ม Program ระบบจะให้ใส่สถานที่ 5 สถานที่ก่อนใช้งาน
  2. เมื่อเราใส่สถานที่ครบเรียบร้อยแล้ว Console จะ show หน้า Menu ให้เราเลือก 
  3. ทุกอย่างจะเหมือนที่โจทย์ระบุไว้ โดยในการเลือก Choice จะเปลี่ยนไปเป็นการ ใช้ ปุ่ม arrow key และ ปุ่ม Enter Key แทน
  4. จะมี Menu Edit location ขึ้นมา โดยจะสามารถเพิ่มสถานที่ และ ลบสถานที่ได้เลย
  5. Program นี้เป็นมิตรกับผู้ใช้งานมาก เพราะงั้นคงไม่ต้องอธิบายไรเพิ่มแล้ว
